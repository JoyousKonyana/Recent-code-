...
namespace BMW_ONBOARDING_SYSTEM.Controllers
{
    ...
    public class QuizController : Controller
    {
        ...
        //[HttpPost]
        //public ActionResult<GetQuizDetailsDto> SubmitQuiz(int courseid,int onboarderid,int quizId,[FromBody] SubmitQuizDto model)
        //{
        ...
        //    foreach(var quiz in model.QuestionsAndOptions)
        //    {
